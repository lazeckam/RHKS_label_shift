...
for i in tqdm(range(N)):
    for n_target in n_target_seq:
        ...
        df_results_ipr.to_csv("./results/"+save_as+"/Bella_logreg_pi_target07.csv", index=False)
        df_results_nrm.to_csv("./results/"+save_as+"/Forman_logreg_pi_target07.csv", index=False)
