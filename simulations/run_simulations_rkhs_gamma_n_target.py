...
for i in tqdm(range(N)):
    for n_target in n_target_seq:
        ...
        df_results_ipr.to_csv("./results/"+save_as+"/ipr_gamma_pi_target"+pi_target_name+".csv", index=False)
        df_results_nrm.to_csv("./results/"+save_as+"/nrm_gamma_pi_target"+pi_target_name+".csv", index=False)
